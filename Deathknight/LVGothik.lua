	...
	["OnEvent"] = function(event, arg1)
		if event == "CHAT_MSG_MONSTER_YELL" then
			if arg1 == LVBM_GOTH_YELL_START1 then
				...
				LVBM.Schedule(25, "LVBM.AddOns.Gothik.OnEvent", "TraineeWarning", 0);
				LVBM.Schedule(74, "LVBM.AddOns.Gothik.OnEvent", "KnightWarning", 0);
				LVBM.Schedule(134, "LVBM.AddOns.Gothik.OnEvent", "RiderWarning", 0);
				
				LVBM.Schedule(27 - 6, "LVBM.AddOns.Gothik.OnEvent", "WaveIncWarning", 1);
				LVBM.Schedule(47 - 6, "LVBM.AddOns.Gothik.OnEvent", "WaveIncWarning", 2);
				LVBM.Schedule(67 - 6, "LVBM.AddOns.Gothik.OnEvent", "WaveIncWarning", 3);
				LVBM.Schedule(77 - 6, "LVBM.AddOns.Gothik.OnEvent", "WaveIncWarning", 4);
				LVBM.Schedule(87 - 6, "LVBM.AddOns.Gothik.OnEvent", "WaveIncWarning", 5);
				LVBM.Schedule(102 - 6, "LVBM.AddOns.Gothik.OnEvent", "WaveIncWarning", 6);
				LVBM.Schedule(107 - 6, "LVBM.AddOns.Gothik.OnEvent", "WaveIncWarning", 7);
				LVBM.Schedule(127 - 6, "LVBM.AddOns.Gothik.OnEvent", "WaveIncWarning", 8);
				LVBM.Schedule(137 - 6, "LVBM.AddOns.Gothik.OnEvent", "WaveIncWarning", 9);
				LVBM.Schedule(147 - 6, "LVBM.AddOns.Gothik.OnEvent", "WaveIncWarning", 10);
				LVBM.Schedule(152 - 6, "LVBM.AddOns.Gothik.OnEvent", "WaveIncWarning", 11);
				LVBM.Schedule(167 - 6, "LVBM.AddOns.Gothik.OnEvent", "WaveIncWarning", 12);
				LVBM.Schedule(177 - 6, "LVBM.AddOns.Gothik.OnEvent", "WaveIncWarning", 13);
				LVBM.Schedule(187 - 6, "LVBM.AddOns.Gothik.OnEvent", "WaveIncWarning", 14);
				LVBM.Schedule(197 - 6, "LVBM.AddOns.Gothik.OnEvent", "WaveIncWarning", 15);
				LVBM.Schedule(202 - 6, "LVBM.AddOns.Gothik.OnEvent", "WaveIncWarning", 16);
				LVBM.Schedule(207 - 6, "LVBM.AddOns.Gothik.OnEvent", "WaveIncWarning", 17);
				LVBM.Schedule(227 - 6, "LVBM.AddOns.Gothik.OnEvent", "WaveIncWarning", 18);
...
--				LVBM.Schedule(267 - 3, "LVBM.AddOns.Gothik.OnEvent", "WaveIncWarning", 22);
				...
				LVBM.StartStatusBarTimer(134, "Rider");
				LVBM.StartStatusBarTimer(74, "Deathknight");
				LVBM.StartStatusBarTimer(25, "Trainees");
